    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <section className="relative h-[80vh] overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 h-full flex flex-col justify-end relative z-10">
          ...
          <Link href="/contact" className="bg-[#F4C7AB] hover:bg-[#E5B89C] text-white px-6 py-3 rounded-lg font-semibold w-fit transition-colors">
            Book Now
          </Link>
        </div>
      </section>
      ...
      <section className="bg-white shadow-md py-6 px-4 mx-4 md:mx-8 -mt-12 relative z-20 rounded-lg">
        <div className="container mx-auto flex flex-col md:flex-row justify-around items-center gap-6">
          <a href="tel:+442012345678" className="flex items-center gap-3 text-gray-700 hover:text-[#A0C1E5] transition-colors">
            <Phone size={24} className="text-[#A0C1E5]" />
            <span>Call Us</span>
          </a>
          <div className="hidden md:block border-r border-gray-200 h-8"></div>
          <a href="https://wa.me/442012345678" className="flex items-center gap-3 text-gray-700 hover:text-[#A0C1E5] transition-colors">
            <MessageCircle size={24} className="text-[#A0C1E5]" />
            <span>WhatsApp</span>
          </a>
          <div className="hidden md:block border-r border-gray-200 h-8"></div>
          <div className="flex items-center gap-3 text-gray-700">
            <Clock size={24} className="text-[#A0C1E5]" />
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/services" className="flex items-center gap-2 text-[#A0C1E5] hover:text-[#8BAFD8] transition-colors">
            <span>See All</span>
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-[#A0C1E5] rounded-full"></span>
